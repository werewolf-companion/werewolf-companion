...
module.exports = {
    init: api => {
        api.get('/meme', (req, res) => {
            ...
            return res.status(200).json(code(200, { url: `https://werewolf.apteryx.xyz/images/memes/${meme}` }));
        })
        ...
        api.get('/gameplay', (req, res) => {
            ...
            return res.status(200).json(code(200, { url: `https://werewolf.apteryx.xyz/images/gameplay/${gameplay}` }));
        })
    }
}
