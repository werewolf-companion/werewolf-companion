...
exports.partnershipEmbed = new Embed({ title: '<:WerewolfCompanion:809419031215734804> Werewolf Companion', description: 'Werewolf Companion is an Android (iOS soon) app and Discord bot made for the players of Werewolf Online, by the players. It contains helpful features such as game information, role information, tips & tricks (submitted by players) media links and more. The Discord bot also comes with a few \'fun\' features including an economy system.', footer: 'Developed by Apteryx, https://apteryx.xyz/' }, [
    ['🅱️ Server', 'https://werewolf.apteryx.xyz/server/invite\nThe Werewolf Companion support server, here you can get help with the app or bot, report any bugs you may encounter, leave suggestions or simply chat with other players.', false],
    ['🤖 Bot', 'https://werewolf.apteryx.xyz/bot/invite\nThe Werewolf Companion bot has many features available to you, like:\n<:werewolf:705737242962034698> | **Role Information** - Useful information for every role in the game.\n<:TipsFedora:809413282230173716> | **Tips & Tricks** - Community submitted tips & tricks for a majority of the role in game.\n<:funny:809417014510485524> | **Memes & Gameplay** - A collection full of Werewolf Online memes and gameplay screenshots.\nThe bot also has an advanced economy and fun system, containing:\n<:gold:705737242080968815> | **Four Currencies** - Earn and buy things with Gold, Roses, Gems, and Loyalty Tokens.\n<:Zombie:709005269425979392> | **Collectables** - Collect all the Werewolf Online roles in your own collection.\nand many more!', false],
    ['📱 App', '<:android:809421546002317352> | https://werewolf.apteryx.xyz/app/android\n<:apple:809421649194778675> | Soon\nThe Werewolf Companion mobile app can be downloaded for free from the Google Play store (iOS version soon), it has plenty of features including:\n🎉 | **Announcements & Giveaways** - a section made for official Werewolf Online announcements and Werewolf Online related giveaways.\n<:SectLeader:709003789499236392> | **Role Information** - Useful information for every role in the game.\n<:TipsFedora:809413772690456586> | **Tips & Tricks** - Community submitted tips & tricks for a majority of the role in game.\n<:Freeman:809415014401310740> | **Free Items** - Information on free items and how to get them in Werewolf Online.\nand many more!\nJoin the support server for updates on the iOS version.', false]
])
...
exports.links = [
    { title: 'Website', value: `Website for Werewolf Companion. Providing more information about the bot, app and API.\n[**VISIT**](${process.env.WEBSITE_DOMAIN})` },
    ...
    { title: 'App', value: `Android app version of the Werewolf Companion app, even containing features which this bot does not have. iOS version is planned.\n[**DOWNLOAD**](${process.env.WEBSITE_DOMAIN}/app/android)` },
